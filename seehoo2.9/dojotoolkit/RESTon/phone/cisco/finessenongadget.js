...
var Finesse = function (username, password) {
	...
	if (method === "GET") {
	  xhrArgs = {
        ...
        //var methodType = xhrArgs。type ;
        //var logger=$caf.newLogger(" @ Send request, methodType:" + methodType);
        //if(methodType != "GET") logger.printXML(xhrArgs.data);
        //logger.close();
    ...
    this.reconnectCall = function (callId, connectionDeviceID, handler, errHandler) {
      var method = "PUT",
      url = _webappPath + "/api/Dialog/" + callId ,
      xml = "<Dialog><targetMediaAddress>"+connectionDeviceID+"</targetMediaAddress><requestedAction>PARTICIPANT_DROP</requestedAction></Dialog>";
      _sendReq(url, method, null, null, handler, errHandler, false, xml);
    };
    ...
    this.sendDTFM = function(callId,myExtension,demfValue,handler, errHandler){
      var method = "PUT",
      url = _webappPath + "/api/Dialog/" + callId ,
      xml = "<Dialog><requestedAction>SEND_DTMF</requestedAction>"+
        "<targetMediaAddress>"+myExtension+"</targetMediaAddress>" +
        "<actionParams>" +
        "<ActionParam>" +
          "<name>dtmfString</name>" +
          "<value>"+defmValue+"</value>" +
        "</ActionParam>" +
        "</actionParams>" +
        "</Dialog>";
      _sendReq(url, method, null, null, handler, errHandler, false, xml);
    ...
    this.consultCall = function(callId,myExtension,toExtension,handler, errHandler){
      var method = "PUT",
      url = _webappPath + "/api/Dialog/" + callId,
      xml = "<Dialog><requestedAction>CONSULT_CALL</requestedAction><toAddress>"+toExtension+"</toAddress><targetMediaAddress>"+myExtension+"</targetMediaAddress></Dialog>"; 
      _sendReq(url, method, null, null, handler, errHandler, false, xml);
    };
    
    this.singleStepTransfer = function(callId,myExtension,toExtension,handler, errHandler){
      var method = "PUT",
      url = _webappPath + "/api/Dialog/" + callId,
      xml = "<Dialog><requestedAction>TRNSFER_SST</requestedAction><toAddress>"+toExtension+"</toAddress><targetMediaAddress>"+myExtension+"</targetMediaAddress></Dialog>"; 
      _sendReq(url, method, null, null, handler, errHandler, false, xml);
    };
    
    this.transfer = function(callId,myExtension,toExtension,handler, errHandler){
      var method = "PUT",
      url = _webappPath + "/api/Dialog/" + callId,
      xml = "<Dialog><requestedAction>TRANSFER</requestedAction><toAddress>"+toExtension+"</toAddress><targetMediaAddress>"+myExtension+"</targetMediaAddress></Dialog>";
      _sendReq(url, method, null, null, handler, errHandler, false, xml);
    };
    
    this.conference = function(callId,myExtension,toExtension,handler, errHandler){
      var method = "PUT",
      url = _webappPath + "/api/Dialog/" + callId,
      xml = "<Dialog><requestedAction>CONFERENCE</requestedAction><toAddress>"+toExtension+"</toAddress><targetMediaAddress>"+myExtension+"</targetMediaAddress></Dialog>";
      _sendReq(url, method, null, null, handler, errHandler, false, xml);
    };
